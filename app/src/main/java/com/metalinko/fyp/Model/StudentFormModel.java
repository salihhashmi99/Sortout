...
public class StudentFormModel {
    ...
    private  String uid ,st_name,st_system_id, st_email,st_contact,st_title,st_dec;
    ...
    public StudentFormModel(String uid, String st_name, String st_system_id, String st_email, String st_contact, String st_title, String st_dec) {
        this.uid = uid;
